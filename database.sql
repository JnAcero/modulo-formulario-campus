-- Active: 1687206440244@@localhost@3306@sgav
CREATE TABLE 
    ruta_entrenamiento(
...
CREATE TABLE
    acudiente(
        id_acudiente INT(11) NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE 
    contacto_empleado(
        id_contacto_empleado INT(11) NOT NULL AUTO_INCREMENT UNIQUE,
        id_empleado INT,
        tipo_locacion_contacto VARCHAR(30) NOT NULL,
        PRIMARY KEY(id_contacto_empleado),
        FOREIGN KEY(id_empleado) REFERENCES empleado(id_empleado)
    );
DROP TABLE contacto_empleado;

ALTER TABLE empleado ADD  contacto_empleado  VARCHAR(15) NOT NULL ;
ALTER TABLE trainer ADD  contacto_trainer  VARCHAR(15) NOT NULL ;
...
CREATE TABLE nivel_campers (
    ...
    CONSTRAINT FK_NivelCamperCamper FOREIGN KEY (id_camper) REFERENCES campers(id_camper),
